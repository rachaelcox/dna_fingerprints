...
data_dir = "/stor/work/Ellington/sanchita/oligos_redux/results/final_combined"

# read in data
chitin <- read_csv(glue("{data_dir}/chitin_20c_fdr5.csv"))
glass <- read_csv(glue("{data_dir}/glass_20c_fdr5.csv"))
strep <- read_csv(glue("{data_dir}/streptavidin_20c_fdr5.csv"))
oligo1 <- read_csv(glue("{data_dir}/oligo1_20c_fdr5.csv"))
oligo2 <- read_csv(glue("{data_dir}/oligo2_20c_fdr5.csv"))
oligo3 <- read_csv(glue("{data_dir}/oligo3_20c_fdr5.csv"))
oligo4 <- read_csv(glue("{data_dir}/oligob_20c_fdr5.csv"))
